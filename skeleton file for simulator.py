...
# code to execute R type instruction #AKSHAT
# code to execute I type instruction #AKSHAT
# code to execute S type instruction #CHIRAG
# code to execute B type instruction (needs to break loop if "00000000000000000000000001100011" found) #CHIRAG
# code to execute U type instruction #JASJYOT
# code to execute J type instruction #JASJYOT
# code to execute bonus type instruction #DHRUV
